...
// SylixosesGetter has a method to return a SylixosInterface.
// A group's client should implement this interface.
type SylixosesGetter interface {
	Sylixoses(namespace string) SylixosInterface
}

// SylixosInterface has methods to work with Sylixos resources.
...
// sylixoses implements SylixosInterface
type sylixoses struct {
	client rest.Interface
	ns     string
}

// newSylixoses returns a Sylixoses
